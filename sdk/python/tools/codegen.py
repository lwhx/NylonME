...
Pin the codegen toolchain to the versions the committed stubs were built with
(see .github/workflows/ci.yml), otherwise the regenerated bytes drift and CI's
"Stubs match the proto" diff fails:

    pip install "grpcio-tools==1.83.0" "protobuf==7.35.1"
"""
